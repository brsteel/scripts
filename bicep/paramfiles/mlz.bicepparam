// Updated to reference the Mission Landing Zone template in sibling repo for test deployment
using '../../../missionlz/src/mlz.bicep'
...
// Added secure Windows VM admin password to satisfy template requirement when deployWindowsVirtualMachine = true.
// Rotate this credential after deployment; do not use in production.
param windowsVmAdminPassword = 'Aq7!s9ZrP$2025X'
