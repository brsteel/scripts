...
@description('Standalone maintenance mode principals for enclave maintenance mode configuration.')
param maintenanceModePrincipals array = []
...
@description('Comma-separated list of CIDR ranges to use for the AKS community connection source. Required when aksRequiredSourceSubnetNames is empty.')
param aksRequiredSourceCidrs string = ''

@description('List of subnet names to dynamically resolve to CIDR ranges for the AKS community connection source. Required when aksRequiredSourceCidrs is empty.')
...
output managedResourceGroupName string = enclaveInfra.outputs.managedResourceGroupName
output subnetConfigurations array = enclaveInfra.outputs.subnetConfigurationsOut
