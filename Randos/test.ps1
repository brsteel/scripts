...
$VaultName = "bws-0-rsv-avd-test-va" #fetch automatically
$Subscription = "mlz-iac-sharedServices" #fetch automatically
$ResourceGroup = "bws-0-rg-management-avd-test-va" #fetch automatically
$SubscriptionId = "3a8f043c-c15c-4a67-9410-a585a85f2109" #fetch automatically
...
$restUri = "https://management.usgovcloudapi.net//subscriptions/"+$SubscriptionId+'/resourcegroups/'+$ResourceGroup+'/providers/Microsoft.RecoveryServices/vaults/'+$VaultName+'?api-version=2021-06-01&operation=DeleteVaultUsingPS'
